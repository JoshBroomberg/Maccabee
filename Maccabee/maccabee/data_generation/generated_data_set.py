...
class DGPVariableAccessor(type):
    ...
    def get_dgp_variable(instance, dgp_var_name):
        ...
        if dgp_var_name not in DGPVariables.all():
    ...
    def __init__(cls, name, bases, clsdict):
        ...
        for dgp_var_external_name, dgp_var_internal_name in DGPVariables.all().items():
            ...
            accessor_meth.__doc__ = f"This property accesses the DGP variable {dgp_var_internal_name} -  :class:`~maccabee.constants.Constants.DGPVariables.{dgp_var_external_name}`)"
