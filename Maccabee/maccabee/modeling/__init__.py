"""This module contains the code used to define and evaluate :term:`causal models <causal model>`. Causal models are responsible for estimating causal effects from observational data (a subset of the data available as part of :class:`~maccabee.data_generation.GeneratedDataSet` instance).
